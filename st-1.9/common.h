...
typedef struct _st_eventsys_ops_new {
    const char *name;                          /* Name of this event system */
    int  val;                                  /* Type of this event system */
    int  (*init)(void*);                        /* Initialization */
    void (*dispatch)(void*);                    /* Dispatch function */
    int  (*pollset_add)(void*,struct pollfd *, int); /* Add descriptor set */
    void (*pollset_del)(void*,struct pollfd *, int); /* Delete descriptor set */
    int  (*fd_new)(void*,int);                       /* New descriptor allocated */
    int  (*fd_close)(void*,int);                     /* Descriptor closed */
    int  (*fd_getlimit)(void*);                 /* Descriptor hard limit */
}_st_eventsys_ops_new_t;
